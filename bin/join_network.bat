...
java -cp %CLASSPATH% i5.las2peer.tools.L2pNodeLauncher -w -p 9012 -b 192.168.178.22:9011 startService('i5.las2peer.services.codeGenerationService.CodeGenerationService') interactive
pause
