...
#java  -cp "lib/*" i5.las2peer.tools.L2pNodeLauncher -p 9012 -b 134.61.131.178:9011 --service-directory service startService\(\'i5.las2peer.services.codeGenerationService.CodeGenerationService@0.1\'\) interactive
