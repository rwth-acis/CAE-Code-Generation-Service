...
/**
 * Global trace model that provides the information about which model elements are located in which files
 * 
...
public class TraceModel {
	...
	private Map<String,FileTraceModel> filenameToFileTraceModel = new HashMap<String, FileTraceModel>();
