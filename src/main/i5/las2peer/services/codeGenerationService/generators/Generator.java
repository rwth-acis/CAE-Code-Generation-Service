...
public abstract class Generator {
  ...
  public static Repository generateNewRepository(String name, String gitHubOrganization,
	...
	case "GitLab":
		//GitLab URLs (Groups)
		// Example: http://ginkgo.informatik.rwth-aachen.de:4080/api/v3/groups/ugnm1617g1CAE/projects/
		url = new URL("http://ginkgo.informatik.rwth-aachen.de:4080/api/v3/groups/" + gitHubOrganization + "/projects");
		break;
	default:
		url = new URL("https://api.github.com/orgs/" + gitHubOrganization + "/repos");
		break;
      ...
      if(usedGitHost == "GitLab") {
    	  GitLabAdapter.createRepo(gitHubOrganization,name, "This repository was generated by the CAE, it features the generated source code from " + name);
      } else {
