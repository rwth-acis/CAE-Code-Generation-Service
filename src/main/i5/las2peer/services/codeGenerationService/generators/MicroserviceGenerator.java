...
public class MicroserviceGenerator extends Generator {
    ...
    public static void createSourceCode(Microservice microservice,
        ...
        try {
            ...
            System.out.println("[Microservice Generator] Git user: " + caeUser.getName() + " and repository name: " + repositoryName);
            ...
            // source code"DatabaseManager.java"
    ...
    protected static void generateOtherArtifacts(TemplateEngine templateEngine,
        ...
        System.out.println("[Microservice Generator - generateOtherArtifacts] Template engine get file name " + templateEngine.getFileName());
        System.out.println("[Microservice Generator - generateOtherArtifacts] File name " + fileName);
        ...
        if (templateEngine.getFileName().equals(getServicePropertiesFileName(microservice))) {
            ...
            if (microservice.getDatabase() == null) {
                ...
                System.out.println("[Microservice Generator - generateOtherArtifacts] SET DATABASE " + microservice.getDatabase().getAddress());
    ...
    protected static void generateNewServiceClass(TemplateEngine templateEngine, String serviceClass,
        ...
        for (int httpMethodIndex = 0; httpMethodIndex < httpMethods.length; httpMethodIndex++) {
            ...
            for (HashMap.Entry<String, HttpPayload> entry: httpPayloads.entrySet()) {
                ...
                if (currentPayload.getPayloadType() == PayloadType.JSONObject) {
                    ...
                    if (schemaName != null && !schemaName.equals("")) {
                        ...
                        parameterCode += type + " " + currentPayload.getName() + ", ";
            ...
            currentMethodTemplate.setVariableIfNotSet("$HTTP_Method_Description$", "");
